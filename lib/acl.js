...
*/
ACL.prototype.hasUserAllPermissionsResource = function(user_id, resources, permissions, cb){
  var acl = this;
...
s
*/
ACL.prototype.hasUserAnyPermissionsResource = function(user_id, resources, permissions, cb) {
  var acl = this;
...
/**
  ...
  @param {Function} Callback called with the result.
*/
ACL.prototype.hasAnyGroupPermissionsResource = function(groups, resources, permissions, cb){
  var acl = this;
