...
- **originalQuery** The cypher query generated by the neo4acl lib. Here the query identifiers are not replaced with those you may provide in the configuration objects
